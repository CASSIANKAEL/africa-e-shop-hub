...
const fr = {
  ...
  store: "Boutique",
  comments: "Commentaires", noComments: "Aucun commentaire pour le moment.", addComment: "Ajouter le commentaire", editComment: "Modifier", deleteComment: "Supprimer", save: "Enregistrer", lastComment: "Dernier commentaire", commentUpdated: "Commentaire modifié", commentDeleted: "Commentaire supprimé", customerInfo: "Client & livraison", callCustomer: "Appeler le client",
...
const messages: Record<AppLanguage, Partial<Dict>> = {
  ...
  de: {
    mobileHome: "Start",
    addProduct: "Produkt hinzufügen", addProductManually: "Produkt manuell hinzufügen", importCsv: "CSV importieren", store: "Shop", comments: "Kommentare", noComments: "Noch kein Kommentar.", addComment: "Kommentar hinzufügen", editComment: "Bearbeiten", deleteComment: "Löschen", save: "Speichern", lastComment: "Letzter Kommentar", commentUpdated: "Kommentar aktualisiert", commentDeleted: "Kommentar gelöscht", customerInfo: "Kunde & Lieferung", callCustomer: "Kunden anrufen",
  ...
  pt: {
    mobileHome: "Início",
    addProduct: "Adicionar produto", addProductManually: "Adicionar um produto manualmente", importCsv: "Importar por CSV", store: "Loja", comments: "Comentários", noComments: "Ainda sem comentários.", addComment: "Adicionar comentário", editComment: "Editar", deleteComment: "Eliminar", save: "Guardar", lastComment: "Último comentário", commentUpdated: "Comentário atualizado", commentDeleted: "Comentário eliminado", customerInfo: "Cliente e entrega", callCustomer: "Ligar ao cliente",
  ...
  ar: {
    mobileHome: "الرئيسية",
    addProduct: "إضافة منتج", addProductManually: "إضافة منتج يدويًا", importCsv: "استيراد CSV", store: "المتجر", comments: "التعليقات", noComments: "لا توجد تعليقات بعد.", addComment: "إضافة تعليق", editComment: "تعديل", deleteComment: "حذف", save: "حفظ", lastComment: "آخر تعليق", commentUpdated: "تم تعديل التعليق", commentDeleted: "تم حذف التعليق", customerInfo: "العميل والتوصيل", callCustomer: "الاتصال بالعميل",

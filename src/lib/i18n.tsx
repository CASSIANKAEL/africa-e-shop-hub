...
const fr = {
  ...
  store: "Boutique",
  comments: "Commentaires", noComments: "Aucun commentaire pour le moment.", addComment: "Ajouter le commentaire", editComment: "Modifier", deleteComment: "Supprimer", lastComment: "Dernier commentaire", commentUpdated: "Commentaire modifié", commentDeleted: "Commentaire supprimé", customerInfo: "Client & livraison", callCustomer: "Appeler le client",
...
const messages: Record<AppLanguage, Partial<Dict>> = {
  ...
  pt: {
    mobileHome: "Início",
    addProduct: "Adicionar produto", addProductManually: "Adicionar um produto manualmente", importCsv: "Importar por CSV", store: "Loja", comments: "Comentários", noComments: "Ainda sem comentários.", addComment: "Adicionar comentário", editComment: "Editar", deleteComment: "Eliminar", lastComment: "Último comentário", commentUpdated: "Comentário atualizado", commentDeleted: "Comentário eliminado", customerInfo: "Cliente e entrega", callCustomer: "Ligar ao cliente",
